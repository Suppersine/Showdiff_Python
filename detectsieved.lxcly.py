...
from utils.general import check_img_size, check_requirements, check_imshow, non_max_suppression_obb, apply_classifier, \
            ...
            if len(det):
                ...
                for *poly, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        annotator.poly_label(poly, label=None, color=colors(int(cls), True))
